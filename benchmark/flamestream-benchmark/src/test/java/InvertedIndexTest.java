...
import com.spbsu.flamestream.example.bl.DataStreamsSource;
import com.spbsu.flamestream.example.bl.FlinkSource;
import com.spbsu.flamestream.example.bl.TestSource;
import com.spbsu.flamestream.example.inverted_index.IndexItemInLong;
import com.spbsu.flamestream.example.inverted_index.WikipeadiaInput;
...
import com.spbsu.flamestream.example.inverted_index.ranking.Document;
...
public class InvertedIndexTest {
  ...
  public void testIndexWithSmallDump(TestSource testSource) throws Exception {
    final Stream<WikipediaPage> source = WikipeadiaInput.dumpStreamFromResources("wikipedia/test_index_small_dump.xml");
  ...
  public void testIndexAndRankingStorageWithSmallDump(TestSource testSource) throws Exception {
    final Stream<WikipediaPage> source = WikipeadiaInput.dumpStreamFromResources("wikipedia/test_index_ranking_storage_small_dump.xml");
