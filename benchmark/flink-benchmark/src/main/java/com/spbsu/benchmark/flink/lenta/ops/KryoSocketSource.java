...
public class KryoSocketSource extends RichParallelSourceFunction<TextDocument> implements CheckpointedFunction {
  ...
  @Override
  public void run(SourceContext<TextDocument> ctx) throws Exception {
    client.addListener(new Listener() {
      ...
      public void received(Connection connection, Object object) {
        if (object instanceof TextDocument) {
          ...
          ctx.collectWithTimestamp((TextDocument) object, currentTime());
