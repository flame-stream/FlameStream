...
public class Classifier implements Function<TfIdfObject, Stream<TfIdfObject>> {
  ...
  public Stream<TfIdfObject> apply(TfIdfObject tfIdfObject) {
    ...
    final TfIdfObject obj = new TfIdfObject(
            tfIdfObject.document(), null, null,
            tfIdfObject.partitioning(), tfIdfObject.number(), predictor.predict(document)
    );
