 ...
 * Date: 28.12.2017
 */
public class WatermarksBenchStand {
  public static void main(String[] args) throws Exception {
    ...
    final WatermarksBenchStand lentaBenchStand = new WatermarksBenchStand(benchConfig);
    try (
            GraphDeployer graphDeployer = new FlameGraphDeployer(
                    benchStandComponentFactory.runtime(deployerConfig),
                    WatermarksGraph.apply(lentaBenchStand.parallelism, lentaBenchStand.iterations),
  ...
  private static final Logger LOG = LoggerFactory.getLogger(WatermarksBenchStand.class);
  ...
  public WatermarksBenchStand(Config benchConfig) {
