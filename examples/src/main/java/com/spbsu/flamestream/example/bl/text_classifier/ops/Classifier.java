...
public class Classifier {
  ...
  public ClassifierState initialState(TfIdfObject tfIdfObject) {
  ...
  public Topic[] topics(ClassifierState classifierState, TfIdfObject tfIdfObject) {
    return model.predict(classifierState.getState(), vectorize(tfIdfObject));
  }

  public ClassifierState newState(ClassifierState classifierState, TfIdfObject tfIdfObject) {
    return new ClassifierState(model.step(
            new DataPoint(vectorize(tfIdfObject), tfIdfObject.label()),
