...
import com.spbsu.flamestream.benchmarks.bl.inverted_index.ops.InvertedIndexState;
...
public class InvertedIndexFlinkRunner implements ClusterRunner {
  ...
  private static class WikipediaPageToWordPositions implements FlatMapFunction<WikipediaPage, Tuple2<String, long[]>> {
    ...
    public void flatMap(WikipediaPage value, Collector<Tuple2<String, long[]>> out) throws Exception {
      final com.spbsu.flamestream.benchmarks.bl.inverted_index.ops.WikipediaPageToWordPositions filter = new com.spbsu.flamestream.benchmarks.bl.inverted_index.ops.WikipediaPageToWordPositions();
