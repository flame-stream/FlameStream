...
public class ZookeeperWatcher extends LoggingActor {
  ...
  private ZookeeperWatcher(ZooKeeper zooKeeper, ActorRef subscriber) {
    this.zooKeeper = zooKeeper;
    this.subscriber = subscriber;
  }

  public static Props props(ZooKeeper zooKeeper, ActorRef notify) {
    return Props.create(ZookeeperWatcher.class, zooKeeper, notify);
  }
