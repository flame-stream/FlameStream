...
start() {
  ...
  local java_ops="-Daeron.term.buffer.length=4194304 -Xms400m -Xmx400m -XX:+PrintGC -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintGCDateStamps -XX:+HeapDumpOnOutOfMemoryError"
